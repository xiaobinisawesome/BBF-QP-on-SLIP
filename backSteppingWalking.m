...
%                     obj.downstepStep = 0;
%                 end
                if obj.downstepStep == 3 && obj.NcontactLegs == 1
                    obj.polar.qs
                end
                if obj.downstepStep == 3 && obj.polar.qs > 0 && obj.NcontactLegs == 1
                    % go back to normal if we've had three steps and the
                    % swing foot is again positive
                    obj.isDownstep = false;
                    obj.downstepStep = 0;
...
%             obj.plot;
    ...
    methods %%% analysis
        function plot(obj)
            ...
            legend('isDownstep','downstepStep','NcontactLegs')
...
%             obj.polar.dLns*sin(obj.polar.qns)*obj.polar.dqns + obj.polar.Lns*cos(obj.polar.qns)*obj.polar.dqns^2 );
        ...
        function [stepL, dstepL] = StepController(obj, t, x, x2f, z2f, dx)
            ...
            elseif obj.useSwingFootDetection && ...
               obj.stepCnt > 9 && ...
               obj.downstepStep == 2
